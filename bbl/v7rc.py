...
def init_ap(essid, password, cb=None, use_default_led=True, set_color=None, udp_ip='192.168.4.1', udp_port=6188):
    ...
    async def start():
        ...
        if cb:
            s = UDPServer()
            tasks.append(s.serve(cb, udp_ip, udp_port))
